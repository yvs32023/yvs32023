 ...
 * @since 03/28/2022
 */
public class DiscardMemberNoteStep extends AbstractUIStep {

	private static final Logger logger = LoggerFactory.getLogger(DiscardMemberNoteStep.class);
	...
	public DiscardMemberNoteStep(String uniqueNoteIdentifier, WebDriver driver) {
	...
	public void run() 
	{
		...
		try
		{
			...
			{
				memberNotesPO.discardNote(uniqueNoteIdentifier);
			}
			else
			{
				memberNotesPO.discardNote();
			}
