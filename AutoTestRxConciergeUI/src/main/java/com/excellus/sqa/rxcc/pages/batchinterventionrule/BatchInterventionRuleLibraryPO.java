 ...
 * 
 */
package com.excellus.sqa.rxcc.pages.batchinterventionrule;
 ...
 *
 */
public class BatchInterventionRuleLibraryPO extends AbstractCommonPage {

    private static final Logger logger = LoggerFactory.getLogger(BatchInterventionRuleLibraryPO.class);

    @FindBy(xpath = "//p-menubar//a[text()='Rx Clinical Concierge']")
    private WebElement menuHomePage;
    @FindBy(xpath = "/html/body/rxc-app/ng-component/rxc-header/header/p-menubar/div/div[1]/div/svg-icon[9]")
   // @FindBy(xpath = "//rxc-header/header/p-menubar/div/p-menubarsub/ul[@role='menubar']/li/a[@href='/Intervention-Rule-Library']")
    private WebElement iconBatchInterventionRuleLib;
    ...
    @FindBy(xpath = "//rxc-intervention-rule-library/main/div/p-table/div/div[1]/rxc-table-header/div[2]/span/input[@placeholder='Search Rules']")
    ...
    public BatchInterventionRuleLibraryPO(WebDriver driver, PageConfiguration page) {
        super(driver, page);
    }
    ...
    public void clickRuleLibrary() throws ElementNotFoundException {
        SeleniumPageHelperAndWaiter.clickWebElement(this, iconBatchInterventionRuleLib);
    }
