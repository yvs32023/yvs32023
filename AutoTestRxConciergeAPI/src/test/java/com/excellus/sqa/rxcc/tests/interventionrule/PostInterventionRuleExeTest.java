...
@DisplayName("PostInterventionRuleEXE")
@UserRole(role = {"RXCC_FULL_MULTI"})
public class PostInterventionRuleExeTest extends InterventionRuleHelper
{
	 ...
	 */
	@TestFactory
	@DisplayName("EXE: Happy Path: Post Intervention Rule")
	@Order(1)
	public List<DynamicNode> happyPathExePost() throws JsonProcessingException
	{
		// Setup test data
		InterventionRule interventionRule = new InterventionRule();

		interventionRule = getNewExeInterventionRule();
	...
	@TestFactory
	@DisplayName("EXE: Happy Path: Post Intervention Rule Without Target")
	@Order(2)
	public List<DynamicNode> happyPathExeWithoutTarget() throws JsonProcessingException
	{
		// Setup test data
		InterventionRule interventionRule = new InterventionRule();
	...
	@TestFactory
	@DisplayName("EXE: Happy Path: Post Intervention Rule Without Prerequisite")
	@Order(3)
	public List<DynamicNode> happyPathExeWithoutPrerequisite () throws JsonProcessingException
	{
		// Setup test data
		InterventionRule interventionRule = new InterventionRule();
	 ...
	 */
	@TestFactory
	@DisplayName("EXE: Negative: Post Intervention Rule Duplicate Rule Name")
	@Order(4)
	...
	@TestFactory
	@DisplayName("EXE: Negative: Post Intervention Rule Either Target or Prerequisites  must be provided")
	@Order(5)
	...
	@TestFactory
	@DisplayName("EXE: Negative: Post Intervention Rule Alternatives  must be provided")
	@Order(6)
	...
	@TestFactory
	@DisplayName("EXE: Negative: Post Intervention Rule FormularyTenantsGroups  must be provided")
	@Order(7)
	...
	@TestFactory
	@DisplayName("EXE: Negative: Post Intervention Rule Invalid Auth")
	@Order(8)
