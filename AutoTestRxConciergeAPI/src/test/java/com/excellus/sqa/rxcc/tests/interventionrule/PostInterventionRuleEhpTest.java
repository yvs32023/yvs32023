 ...
 * {
    ...
    "faxAlternatives": [
        {
            "productName": "string",
            "faxAlternativeProductName": "string"
       }
    ],
...
@DisplayName("PostInterventionRuleEHP")
@UserRole(role = {"RXCC_FULL_SINGLE","RXCC_FULL_MULTI"})
public class PostInterventionRuleEhpTest extends InterventionRuleHelper
{
	 ...
	 */
	@TestFactory
	@DisplayName("EHP: Happy Path: Post Intervention Rule")
	@Order(1)
	public List<DynamicNode> happyPathPost() throws JsonProcessingException
	{
		...
		interventionRule = getNewEhpInterventionRule();
	...
	@TestFactory
	@DisplayName("EHP: Happy Path: Post Intervention Rule Without Target")
	@Order(2)
	...
	@TestFactory
	@DisplayName("EHP: Happy Path: Post Intervention Rule Without Prerequisite")
	@Order(3)
	 ...
	 */
	@TestFactory
	@DisplayName("EHP: Negative: Post Intervention Rule Duplicate Rule Name")
	@Order(4)
	...
	@TestFactory
	@DisplayName("EHP: Negative: Post Intervention Rule Either Target or Prerequisites  must be provided")
	@Order(5)
	...
	@TestFactory
	@DisplayName("EHP: Negative: Post Intervention Rule Alternatives  must be provided")
	@Order(6)
	...
	@TestFactory
	@DisplayName("EHP: Negative: Post Intervention Rule Invalid Auth")
	@Order(8)
